...
public class H2JdbcUrlFactory {
  ...
  public H2JdbcUrlFactory(File databaseDirectory, String databaseName, String username,
      String password) {
  ...
  private String toUrlOption(String[] options) {
    if (options.length == 0) {
      return "";
    }
   ...
   * @return
   */
  public JdbcConnectionPool newInMemoryModeConnectionPool(String... options) {
   ...
   * @return
   */
  public JdbcConnectionPool newServerModeConnectionPool(String... options) {
   ...
   * @return
   */
  public JdbcConnectionPool newEmbeddedModeConnectionPool(String... options) {
   ...
   * @return
   */
  public JdbcConnectionPool newMixedModeConnectionPool(String... options) {
  ...
  public static class Builder {
    ...
    /**
     * Initializes a newly created {@code H2JdbcUrlFactory.Builder} object; you can get
     * {{@code H2JdbcUrlFactory} object via {@link #build()} method.
     *
    ...
    public H2JdbcUrlFactory build() {
      return new H2JdbcUrlFactory(databaseDirectory, databaseName, username, password);
    }
  }
